...
func (r RequestProofOfWeight) Encode(enc *protocol.MessageEncoder) (em protocol.EncodedMessage, err error) {
...
func (r *RequestProofOfWeight) Decode(dec *protocol.MessageDecoder) (err error) {
...
func CreateRequestProofOfWeight(nb uint32, t protocol.Hash) (em protocol.EncodedMessage) {
	em, _ = RequestProofOfWeight{
		TotalNumberOfBlocks: nb,
		Tip:                 t,
	}.Encode(protocol.NewMessageEncoder(42))
	return
}
